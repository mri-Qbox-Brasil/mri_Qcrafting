        ...
        if data then
            ...
            for i=1, #data do 
                ...
                options[#options+1] = {
                    ...
                    arrow = true,
                    args = {craft_name = dat.craft_name, craft_id = dat.craft_id}
                }
            end
            lib.registerContext({
                id = 'crafting_list',
            ...
            options = {
              {
                ...
                onSelect = function()
                    ...
                    if warning == "confirm" then 
                        ...
                        notification(locales.main_title, locales.changedname ..""..args.craft_name.. "" ..locales.to_question.. "" ..input[1], types.success)
                        Wait(100)
                                                            ...
                                                            options = {
                                                                {
                                                                    ...
                                                                    onSelect = function()
                                                                        local warning = lib.alertDialog({
                                                                            header = locales.automaticmessage,
                                                                            content = locales.automatic_deleteitem ..someData.item_label.."?",
                                                                            centered = true,
                                                                            cancel = true
                                                                        })
                                                                        if warning == "confirm" then 
                                                                            local deleteData = { craft_id = someData.craft_id, item = someData.item, item_label = someData.item_label } 
                                                                            TriggerServerEvent("qt-crafting:UpdateItems", args.craft_id, someData.item, nil, "delete")
                                                                        else
                                                                            notification(locales.main_title, locales.canceled_deletingitem, types.info)
                                                                        end
                                                                    end,
                                                                },
                                                                {
                            ...
                            options = {
                                {
                                    ...
                                    onSelect = function()
                                        ...
                                        },
                                        {
                                            ...
                                            description = locales.desc_job_req,
                                            disabled = jobRequire,
                                        },
                                }
                            })
...
AddEventHandler("qt-crafting:CreateMenu", function()
    local input = lib.inputDialog(locales.creation_menu, {
        ...
        { type = "checkbox", label = locales.blip, checked = false },
    })
    if not input then return end
    ...
    QT.TriggerCallback("qt-crafting:TableExist", function(exist)
        ...
        if input[4] then
            ...
            blip_data = { sprite = enableblip.sprite, colour = enableblip.colour, scale = enableblip.scale, blip_label = enableblip.blip_label }
        end
        ...
        CreateThread(function()
            ...
            ---@diagnostic disable-next-line: need-check-nil
                ...
                if IsDisabledControlPressed(0, 176) then
                    local newData = { craft_name = input[1], prop = input[2], jobrequire = input[3], requireblip = input[4], blip = blip_data, jobs = jobData, propcoords = vector3(coords.x, coords.y, coords.z), heading = heading, jobenable = input[3], blipenable = input[4]}
